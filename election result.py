...
print("\nKeys of biden_reviews dataset:")
print(biden_reviews.keys())
print('users of biden_reviews dataset')
print(biden_reviews['user'])
print('text of biden_reviews dataset')
print(biden_reviews['text'])
print("\nNumber of rows and columns of biden_reviews dataset:")
print(biden_reviews.shape)
print("\nKeys of trump_reviews dataset:")
print(trump_reviews.keys())
print('users of trump_reviews dataset')
print(trump_reviews['user'])
print('text of biden_reviews dataset')
print(trump_reviews['text'])
print("\nNumber of rows and columns of trump_reviews dataset:")
